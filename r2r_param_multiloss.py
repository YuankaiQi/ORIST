...
class BertParam:
    def __init__(self):
        ...
        self.parser.add_argument("--aug_path_cahche", type=str, default='/path/to/aug_path_cache.json')
        ...
        # for ndh
        self.parser.add_argument('--path_type', type=str, default='mixed', help='oracle, navigator, mixed')
        # for multi loss
        ...
        # for reverie
        self.parser.add_argument("--bboxDir",
                                 default='tasks/REVERIE/data/BBox', type=str,
                                 help="json file for model architecture")
...
args.bboxDir = f'tasks/{args.task}/data/BBox'
