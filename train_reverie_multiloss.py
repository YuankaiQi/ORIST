...
from eval import MultiEvaluationREVERIE
from r2r_param_multiloss import args
import warnings
warnings.filterwarnings("ignore")
from datetime import datetime
from tensorboardX import SummaryWriter
metrics = ['lengths','success_rate','oracle_rate','spl','steps', 'angle_acc', 'next_region_acc',
...
def valid(train_env, tok, val_envs={}):
    ...
    for env_name, (env, evaluator) in val_envs.items():
        ...
        val_loader = DataLoader(dataset=val_split_data, batch_size=args.val_batch_size, shuffle=False,
                                sampler=val_sampler)
...
def train_val():
    ...
    if args.features=='none':
        ...
        feat_dict = read_img_features(args.features, args)
    ...
    val_envs = OrderedDict(
        ((split,
          (R2RBatch(feat_dict, batch_size=args.val_batch_size, splits=[split], tokenizer=tok,seed=args.seed, bert_tokenizer=bert_tok,
           ...
           MultiEvaluationREVERIE([split], featurized_scans, tok, args=args))
          )
